                           ...
                           <tr>
                              <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 5px;" valign="top">
                                             ...
                                             ¡Muchas gracias por participar en el <b>9no Concurso de Cómics del Festival Aguacero Comics 2023</b>!.<br>
                                             Su trabajo ha sido recibido correctamente con fecha <b><?= $created_at; ?>
                                             </p>
                                          </td>
                                       </tr>
                                    </tbody>
                                 ...
                                 <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; color: #999999;">
                                    <i>Si existe algun problema con tu participación, comunicate con nosotros al correo competencia@aguacerocomics.cl</i>
                                 </p>
                                 <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                    <!-- texto -->
                                 </p>
