    ...
    <div class="collapse navbar-collapse flex-grow-0" id="navbar_top">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url('#homenajeados');?>"><b>Homenajeados</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#cards');?>"><b>Charlas</b></a>
        </li>
        <li class="nav-item">
        ...
        -->
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#concurso');?>"><b>CONCURSO</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#honorees');?>"><b>INVITADOS</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#galeria');?>"><b>GANADORES</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#noticias');?>"><b>NOTICIAS</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('home/stands');?>"><b>POSTULACION STANDS</b></a>
        </li>
        <!--
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('#aboutus');?>"><b>Nosotros</b> <span class="sr-only">(current)</span></a>
        </li>
        -->
